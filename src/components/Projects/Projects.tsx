...
// Usamos 'import type' para garantir compatibilidade com o compilador do Vite
...
const Projects = ({ onProjectClick, projectImages }: ProjectsProps) => {
  ...
  // Adicionamos um fallback (|| []) para evitar erro caso a tradução ainda não tenha carregado
  ...
  return (
    // Removido o id="projects" pois agora o acesso é via rota /projects
